...
function bindBlogForm() {
  ...
  titleInput?.addEventListener("input", () => {
    ...
    if (slugInput.dataset.autogenerated !== "false" || !slugInput.value.trim()) {
  ...
  slugInput?.addEventListener("input", () => {
    const automaticValue = slugifyText(titleInput?.value || "");
    const currentValue = slugifyText(slugInput.value);
    slugInput.value = currentValue;
    slugInput.dataset.autogenerated =
      !currentValue || currentValue === automaticValue ? "true" : "false";
  });
      ...
      <article class="admin-list-item">
        ...
        <div class="admin-list-item-header">
          <div>
            ...
            <p>${escapeHtml(post.slug || slugifyText(post.title || ""))}</p>
          </div>
          <div class="admin-list-actions">
...
function populateBlogForm(post) {
  const slug = post?.slug || slugifyText(post?.title || "");
  document.querySelector("#blog-post-id").value = post?.id || "";
  document.querySelector("#blog-title").value = post?.title || "";
  document.querySelector("#blog-slug").value = slug;
  document.querySelector("#blog-slug").dataset.autogenerated =
    slug === slugifyText(post?.title || "") ? "true" : "false";
...
function resetBlogForm() {
  ...
  document.querySelector("#blog-image").value = "";
  document.querySelector("#blog-slug").value = "";
  document.querySelector("#blog-slug").dataset.autogenerated = "true";
